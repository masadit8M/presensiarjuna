...
CREATE TABLE IF NOT EXISTS cabang (
    text_code VARCHAR(20) PRIMARY KEY, -- changed to map properly
...
-- Map PST & CB1 properly
INSERT INTO cabang (text_code, kode_cabang, nama_cabang, lokasi_cabang, radius_cabang) VALUES
('PST', 'PST', 'Kantor Pusat', '-7.9818987,112.626503', 100), -- Malang area example
('CB1', 'CB1', 'Cabang Surabaya', '-7.250444,112.768845', 150)
